        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <select name="role" id="role" class="form-control">
                                    <option value="2" @php if ($role->name == 'user') echo ' selected' @endphp>Пользователь</option>
                                    <option value="3" @php if ($role->name == 'admin') echo ' selected' @endphp>Администратор</option>
                ...
                <div class="text-center">
                    <p>{{($count_orders)}} заказа из {{$count}} </p>
