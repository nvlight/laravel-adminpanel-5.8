...
{{--                    {{url('/admin/filter/attr-edit', $atrr->id)}}--}}
                    <form action="{{route('blog.admin.filter.attribute-edit', $attr->id)}}" method="post" data-toggle="validator" id="addattrs">
                        @csrf
                        <div class="box-body">
                            <div class="form-group has-feedback">
                                <label for="value">Наименование</label>
                                <input type="text" name="value" class="form-control" id="value" placeholder="Наименование" value="{{$attr->value}}" required>
